...
func (m *MockIDataAccessLayer) SaveItem(input *dynamodb.UpdateItemInput) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveItem", input)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveItem indicates an expected call of SaveItem.
func (mr *MockIDataAccessLayerMockRecorder) SaveItem(input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveItem", reflect.TypeOf((*MockIDataAccessLayer)(nil).SaveItem), input)
}
